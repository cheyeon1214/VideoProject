...
void debug_bytes(uint8* buf, int len)
{
    int i;
    for (i = 0; i < len; i++)
    {
        bs_trace("%02X ", buf[i]);
        if ((i+1) % 16 == 0) { bs_trace ("\r\n"); }
    }
    bs_trace("\r\n");
}
...
int read_nal_unit(h264_stream_t* h, uint8* buf, int size)
{
    nal_t* nal = h->nal;

    int nal_size = size;
    int rbsp_size = size;
    uint8* rbsp_buf = (uint8*)calloc(1, rbsp_size);
    ...
    if( nal->nal_unit_type == 14 || nal->nal_unit_type == 21 || nal->nal_unit_type == 20 )
    {
        ...
        {
            nal->svc_extension_flag = bs_read_u1(b) != 0;
        }
        else
        {
            nal->avc_3d_extension_flag = bs_read_u1(b) != 0;
        }
...
void read_nal_unit_header_svc_extension(nal_svc_ext_t* nal_svc_ext, bs_t* b)
{
    nal_svc_ext->idr_flag = bs_read_u1(b) != 0;
    nal_svc_ext->priority_id = bs_read_u(b, 6);
    nal_svc_ext->no_inter_layer_pred_flag = bs_read_u1(b) != 0;
    nal_svc_ext->dependency_id = bs_read_u(b, 3);
    nal_svc_ext->quality_id = bs_read_u(b, 4);
    nal_svc_ext->temporal_id = bs_read_u(b, 3);
    nal_svc_ext->use_ref_base_pic_flag = bs_read_u1(b) != 0;
    nal_svc_ext->discardable_flag = bs_read_u1(b) != 0;
    nal_svc_ext->output_flag = bs_read_u1(b) != 0;
...
void read_prefix_nal_unit_svc(nal_t* nal, bs_t* b)
{
    ...
    {
        nal->prefix_nal_svc->store_ref_base_pic_flag = bs_read_u1(b) != 0;
        ...
        nal->prefix_nal_svc->additional_prefix_nal_unit_extension_flag = bs_read_u1(b) != 0;
        if( nal->prefix_nal_svc->additional_prefix_nal_unit_extension_flag )
        {
            while( more_rbsp_data( b ) )
            {
                nal->prefix_nal_svc->additional_prefix_nal_unit_extension_data_flag = bs_read_u1(b) != 0;
            }
        }
    }
...
void read_subset_seq_parameter_set_rbsp(sps_subset_t* sps_subset, bs_t* b)
{
	...
	case 86:
		{
			...
			sps_svc_ext->svc_vui_parameters_present_flag = bs_read_u1(b) != 0;
	...
	sps_subset->additional_extension2_flag = bs_read_u1(b) != 0;
...
{
    sps_svc_ext_t* sps_svc_ext = sps_subset->sps_svc_ext;
    sps_svc_ext->inter_layer_deblocking_filter_control_present_flag = bs_read_u1(b) != 0;
    ...
    {
        sps_svc_ext->chroma_phase_x_plus1_flag = bs_read_u1(b) != 0;
    }
    ...
    if( sps_svc_ext->extended_spatial_scalability_idc )
    {
        ...
        {
            sps_svc_ext->seq_ref_layer_chroma_phase_x_plus1_flag = bs_read_u1(b) != 0;
    ...
    sps_svc_ext->seq_tcoeff_level_prediction_flag = bs_read_u1(b) != 0;
    if( sps_svc_ext->seq_tcoeff_level_prediction_flag )
    {
        sps_svc_ext->adaptive_tcoeff_level_prediction_flag = bs_read_u1(b) != 0;
    }
    sps_svc_ext->slice_header_restriction_flag = bs_read_u1(b) != 0;
}
...
void read_svc_vui_parameters_extension(sps_svc_ext_t* sps_svc_ext, bs_t* b)
{
    ...
    for( int i = 0; i <= sps_svc_ext->vui.vui_ext_num_entries_minus1; i++ )
    {
        ...
        if( sps_svc_ext->vui.vui_ext_timing_info_present_flag[i] )
        {
            ...
            sps_svc_ext->vui.vui_ext_fixed_frame_rate_flag[i] = bs_read_u1(b) != 0;
        }

        sps_svc_ext->vui.vui_ext_nal_hrd_parameters_present_flag[i] = bs_read_u1(b) != 0;
        if( sps_svc_ext->vui.vui_ext_nal_hrd_parameters_present_flag[i] )
        {
            read_hrd_parameters(&sps_svc_ext->hrd_vcl[i], b);
        }
        sps_svc_ext->vui.vui_ext_vcl_hrd_parameters_present_flag[i] = bs_read_u1(b) != 0;
        ...
        {
            sps_svc_ext->vui.vui_ext_low_delay_hrd_flag[i] = bs_read_u1(b) != 0;
        }
        sps_svc_ext->vui.vui_ext_pic_struct_present_flag[i] = bs_read_u1(b) != 0;
    }
}
...
void read_slice_layer_rbsp(h264_stream_t* h,  bs_t* b)
{
    ...
    if ( slice_data != NULL )
    {
        ...
        uint8 *sptr = b->p + (!!b->bits_left); // CABAC-specific: skip alignment bits, if there are any
        slice_data->rbsp_size = (int)(b->end - sptr);
        
        slice_data->rbsp_buf = (uint8*)malloc(slice_data->rbsp_size);
...
void read_slice_header_in_scalable_extension(h264_stream_t* h, bs_t* b)
{
    ...
    if( nal->nal_svc_ext->quality_id == 0)
    {
            ...
            ( pps->weighted_bipred_idc == 1 && is_slice_type( sh->slice_type, SH_SLICE_TYPE_EB ) ) )
        {
            ...
            {
                sh_svc_ext->base_pred_weight_table_flag = bs_read_u1(b) != 0;
            }
        ...
        if( nal->nal_ref_idc != 0 )
        {
            ...
            {
                sh_svc_ext->store_ref_base_pic_flag = bs_read_u1(b) != 0;
    ...
    if( !nal->nal_svc_ext->no_inter_layer_pred_flag && nal->nal_svc_ext->quality_id == 0 )
    {
        ...
        sh_svc_ext->constrained_intra_resampling_flag = bs_read_u1(b) != 0;
        if( sps_subset->sps_svc_ext->extended_spatial_scalability_idc == 2 )
        {
            if( sps_subset->sps->chroma_format_idc > 0 )
            {
                sh_svc_ext->ref_layer_chroma_phase_x_plus1_flag = bs_read_u1(b) != 0;
    ...
    if( !nal->nal_svc_ext->no_inter_layer_pred_flag )
    {
        sh_svc_ext->slice_skip_flag = bs_read_u1(b) != 0;
        ...
        {
            sh_svc_ext->adaptive_base_mode_flag = bs_read_u1(b) != 0;
            if( !sh_svc_ext->adaptive_base_mode_flag )
            {
                sh_svc_ext->default_base_mode_flag = bs_read_u1(b) != 0;
            }
            if( !sh_svc_ext->default_base_mode_flag )
            {
                sh_svc_ext->adaptive_motion_prediction_flag = bs_read_u1(b) != 0;
                if( !sh_svc_ext->adaptive_motion_prediction_flag )
                {
                    sh_svc_ext->default_motion_prediction_flag = bs_read_u1(b) != 0;
                }
            }
            sh_svc_ext->adaptive_residual_prediction_flag = bs_read_u1(b) != 0;
            if( !sh_svc_ext->adaptive_residual_prediction_flag )
            {
                sh_svc_ext->default_residual_prediction_flag = bs_read_u1(b) != 0;
            }
        }
        if( sps_subset->sps_svc_ext->adaptive_tcoeff_level_prediction_flag )
        {
            sh_svc_ext->tcoeff_level_prediction_flag = bs_read_u1(b) != 0;
        }
    }
...
void read_dec_ref_base_pic_marking(nal_t* nal, bs_t* b)
{
    nal->prefix_nal_svc->adaptive_ref_base_pic_marking_mode_flag = bs_read_u1(b) != 0;
...
//7.3.1 NAL unit syntax
int write_nal_unit(h264_stream_t* h, uint8* buf, int size)
{
    nal_t* nal = h->nal;
...
//7.3.1 NAL unit syntax
int read_debug_nal_unit(h264_stream_t* h, uint8* buf, int size)
{
    nal_t* nal = h->nal;
    ...
    bs_t* b = bs_new(rbsp_buf, rbsp_size);
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); int forbidden_zero_bit = bs_read_u(b, 1); bs_trace("forbidden_zero_bit: %d \r\n", forbidden_zero_bit); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->nal_ref_idc = bs_read_u(b, 2); bs_trace("nal->nal_ref_idc: %d \r\n", nal->nal_ref_idc); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->nal_unit_type = bs_read_u(b, 5); bs_trace("nal->nal_unit_type: %d \r\n", nal->nal_unit_type); 
    
    if( nal->nal_unit_type == 14 || nal->nal_unit_type == 21 || nal->nal_unit_type == 20 )
    {
        if( nal->nal_unit_type != 21 )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->svc_extension_flag = bs_read_u1(b) != 0; bs_trace("nal->svc_extension_flag: %d \r\n", nal->svc_extension_flag); 
        }
        else
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->avc_3d_extension_flag = bs_read_u1(b) != 0; bs_trace("nal->avc_3d_extension_flag: %d \r\n", nal->avc_3d_extension_flag); 
        }
...
void read_debug_nal_unit_header_svc_extension(nal_svc_ext_t* nal_svc_ext, bs_t* b)
{
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->idr_flag = bs_read_u1(b) != 0; bs_trace("nal_svc_ext->idr_flag: %d \r\n", nal_svc_ext->idr_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->priority_id = bs_read_u(b, 6); bs_trace("nal_svc_ext->priority_id: %d \r\n", nal_svc_ext->priority_id); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->no_inter_layer_pred_flag = bs_read_u1(b) != 0; bs_trace("nal_svc_ext->no_inter_layer_pred_flag: %d \r\n", nal_svc_ext->no_inter_layer_pred_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->dependency_id = bs_read_u(b, 3); bs_trace("nal_svc_ext->dependency_id: %d \r\n", nal_svc_ext->dependency_id); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->quality_id = bs_read_u(b, 4); bs_trace("nal_svc_ext->quality_id: %d \r\n", nal_svc_ext->quality_id); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->temporal_id = bs_read_u(b, 3); bs_trace("nal_svc_ext->temporal_id: %d \r\n", nal_svc_ext->temporal_id); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->use_ref_base_pic_flag = bs_read_u1(b) != 0; bs_trace("nal_svc_ext->use_ref_base_pic_flag: %d \r\n", nal_svc_ext->use_ref_base_pic_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->discardable_flag = bs_read_u1(b) != 0; bs_trace("nal_svc_ext->discardable_flag: %d \r\n", nal_svc_ext->discardable_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->output_flag = bs_read_u1(b) != 0; bs_trace("nal_svc_ext->output_flag: %d \r\n", nal_svc_ext->output_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal_svc_ext->reserved_three_2bits = bs_read_u(b, 2); bs_trace("nal_svc_ext->reserved_three_2bits: %d \r\n", nal_svc_ext->reserved_three_2bits); 
}
...
void read_debug_prefix_nal_unit_svc(nal_t* nal, bs_t* b)
{
    if( nal->nal_ref_idc != 0 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->prefix_nal_svc->store_ref_base_pic_flag = bs_read_u1(b) != 0; bs_trace("nal->prefix_nal_svc->store_ref_base_pic_flag: %d \r\n", nal->prefix_nal_svc->store_ref_base_pic_flag); 
        if( ( nal->nal_svc_ext->use_ref_base_pic_flag || nal->prefix_nal_svc->store_ref_base_pic_flag ) &&
             !nal->nal_svc_ext->idr_flag )
        {
            read_debug_dec_ref_base_pic_marking( nal, b );
        }
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->prefix_nal_svc->additional_prefix_nal_unit_extension_flag = bs_read_u1(b) != 0; bs_trace("nal->prefix_nal_svc->additional_prefix_nal_unit_extension_flag: %d \r\n", nal->prefix_nal_svc->additional_prefix_nal_unit_extension_flag); 
        if( nal->prefix_nal_svc->additional_prefix_nal_unit_extension_flag )
        {
            while( more_rbsp_data( b ) )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->prefix_nal_svc->additional_prefix_nal_unit_extension_data_flag = bs_read_u1(b) != 0; bs_trace("nal->prefix_nal_svc->additional_prefix_nal_unit_extension_data_flag: %d \r\n", nal->prefix_nal_svc->additional_prefix_nal_unit_extension_data_flag); 
            }
        }
    }
    else if( more_rbsp_data( b ) )
...
void read_debug_seq_parameter_set_rbsp(sps_t* sps, bs_t* b)
{
    ...
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->profile_idc = bs_read_u8(b); bs_trace("sps->profile_idc: %d \r\n", sps->profile_idc); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->constraint_set0_flag = bs_read_u1(b); bs_trace("sps->constraint_set0_flag: %d \r\n", sps->constraint_set0_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->constraint_set1_flag = bs_read_u1(b); bs_trace("sps->constraint_set1_flag: %d \r\n", sps->constraint_set1_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->constraint_set2_flag = bs_read_u1(b); bs_trace("sps->constraint_set2_flag: %d \r\n", sps->constraint_set2_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->constraint_set3_flag = bs_read_u1(b); bs_trace("sps->constraint_set3_flag: %d \r\n", sps->constraint_set3_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->constraint_set4_flag = bs_read_u1(b); bs_trace("sps->constraint_set4_flag: %d \r\n", sps->constraint_set4_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->constraint_set5_flag = bs_read_u1(b); bs_trace("sps->constraint_set5_flag: %d \r\n", sps->constraint_set5_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); int reserved_zero_2bits = bs_read_u(b, 2); bs_trace("reserved_zero_2bits: %d \r\n", reserved_zero_2bits); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->level_idc = bs_read_u8(b); bs_trace("sps->level_idc: %d \r\n", sps->level_idc); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->seq_parameter_set_id = bs_read_ue(b); bs_trace("sps->seq_parameter_set_id: %d \r\n", sps->seq_parameter_set_id); 
    ...
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->chroma_format_idc = bs_read_ue(b); bs_trace("sps->chroma_format_idc: %d \r\n", sps->chroma_format_idc); 
        if( sps->chroma_format_idc == 3 )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->residual_colour_transform_flag = bs_read_u1(b); bs_trace("sps->residual_colour_transform_flag: %d \r\n", sps->residual_colour_transform_flag); 
        }
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->bit_depth_luma_minus8 = bs_read_ue(b); bs_trace("sps->bit_depth_luma_minus8: %d \r\n", sps->bit_depth_luma_minus8); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->bit_depth_chroma_minus8 = bs_read_ue(b); bs_trace("sps->bit_depth_chroma_minus8: %d \r\n", sps->bit_depth_chroma_minus8); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->qpprime_y_zero_transform_bypass_flag = bs_read_u1(b); bs_trace("sps->qpprime_y_zero_transform_bypass_flag: %d \r\n", sps->qpprime_y_zero_transform_bypass_flag); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->seq_scaling_matrix_present_flag = bs_read_u1(b); bs_trace("sps->seq_scaling_matrix_present_flag: %d \r\n", sps->seq_scaling_matrix_present_flag); 
        if( sps->seq_scaling_matrix_present_flag )
        {
            for( i = 0; i < 8; i++ )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->seq_scaling_list_present_flag[ i ] = bs_read_u1(b); bs_trace("sps->seq_scaling_list_present_flag[ i ]: %d \r\n", sps->seq_scaling_list_present_flag[ i ]); 
                if( sps->seq_scaling_list_present_flag[ i ] )
                {
                    if( i < 6 )
                    {
    ...
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->log2_max_frame_num_minus4 = bs_read_ue(b); bs_trace("sps->log2_max_frame_num_minus4: %d \r\n", sps->log2_max_frame_num_minus4); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->pic_order_cnt_type = bs_read_ue(b); bs_trace("sps->pic_order_cnt_type: %d \r\n", sps->pic_order_cnt_type); 
    if( sps->pic_order_cnt_type == 0 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->log2_max_pic_order_cnt_lsb_minus4 = bs_read_ue(b); bs_trace("sps->log2_max_pic_order_cnt_lsb_minus4: %d \r\n", sps->log2_max_pic_order_cnt_lsb_minus4); 
    }
    else if( sps->pic_order_cnt_type == 1 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->delta_pic_order_always_zero_flag = bs_read_u1(b); bs_trace("sps->delta_pic_order_always_zero_flag: %d \r\n", sps->delta_pic_order_always_zero_flag); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->offset_for_non_ref_pic = bs_read_se(b); bs_trace("sps->offset_for_non_ref_pic: %d \r\n", sps->offset_for_non_ref_pic); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->offset_for_top_to_bottom_field = bs_read_se(b); bs_trace("sps->offset_for_top_to_bottom_field: %d \r\n", sps->offset_for_top_to_bottom_field); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->num_ref_frames_in_pic_order_cnt_cycle = bs_read_ue(b); bs_trace("sps->num_ref_frames_in_pic_order_cnt_cycle: %d \r\n", sps->num_ref_frames_in_pic_order_cnt_cycle); 
        for( i = 0; i < sps->num_ref_frames_in_pic_order_cnt_cycle; i++ )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->offset_for_ref_frame[ i ] = bs_read_se(b); bs_trace("sps->offset_for_ref_frame[ i ]: %d \r\n", sps->offset_for_ref_frame[ i ]); 
        }
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->num_ref_frames = bs_read_ue(b); bs_trace("sps->num_ref_frames: %d \r\n", sps->num_ref_frames); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->gaps_in_frame_num_value_allowed_flag = bs_read_u1(b); bs_trace("sps->gaps_in_frame_num_value_allowed_flag: %d \r\n", sps->gaps_in_frame_num_value_allowed_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->pic_width_in_mbs_minus1 = bs_read_ue(b); bs_trace("sps->pic_width_in_mbs_minus1: %d \r\n", sps->pic_width_in_mbs_minus1); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->pic_height_in_map_units_minus1 = bs_read_ue(b); bs_trace("sps->pic_height_in_map_units_minus1: %d \r\n", sps->pic_height_in_map_units_minus1); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->frame_mbs_only_flag = bs_read_u1(b); bs_trace("sps->frame_mbs_only_flag: %d \r\n", sps->frame_mbs_only_flag); 
    if( !sps->frame_mbs_only_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->mb_adaptive_frame_field_flag = bs_read_u1(b); bs_trace("sps->mb_adaptive_frame_field_flag: %d \r\n", sps->mb_adaptive_frame_field_flag); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->direct_8x8_inference_flag = bs_read_u1(b); bs_trace("sps->direct_8x8_inference_flag: %d \r\n", sps->direct_8x8_inference_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->frame_cropping_flag = bs_read_u1(b); bs_trace("sps->frame_cropping_flag: %d \r\n", sps->frame_cropping_flag); 
    if( sps->frame_cropping_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->frame_crop_left_offset = bs_read_ue(b); bs_trace("sps->frame_crop_left_offset: %d \r\n", sps->frame_crop_left_offset); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->frame_crop_right_offset = bs_read_ue(b); bs_trace("sps->frame_crop_right_offset: %d \r\n", sps->frame_crop_right_offset); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->frame_crop_top_offset = bs_read_ue(b); bs_trace("sps->frame_crop_top_offset: %d \r\n", sps->frame_crop_top_offset); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->frame_crop_bottom_offset = bs_read_ue(b); bs_trace("sps->frame_crop_bottom_offset: %d \r\n", sps->frame_crop_bottom_offset); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui_parameters_present_flag = bs_read_u1(b); bs_trace("sps->vui_parameters_present_flag: %d \r\n", sps->vui_parameters_present_flag); 
    if( sps->vui_parameters_present_flag )
    {
...
void read_debug_scaling_list(bs_t* b, int* scalingList, int sizeOfScalingList, int* useDefaultScalingMatrixFlag )
{
    ...
    for( int j = 0; j < sizeOfScalingList; j++ )
    {
        if( nextScale != 0 )
        {
            ...
            //bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); delta_scale = bs_read_se(b); bs_trace("delta_scale: %d \r\n", delta_scale); 
            delta_scale = bs_read_se(b);
...
void read_debug_subset_seq_parameter_set_rbsp(sps_subset_t* sps_subset, bs_t* b)
{
	...
	case 86:
		{
			...
			sps_svc_ext_t* sps_svc_ext = sps_subset->sps_svc_ext;
			bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->svc_vui_parameters_present_flag = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->svc_vui_parameters_present_flag: %d \r\n", sps_svc_ext->svc_vui_parameters_present_flag); 
	...
	bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_subset->additional_extension2_flag = bs_read_u1(b) != 0; bs_trace("sps_subset->additional_extension2_flag: %d \r\n", sps_subset->additional_extension2_flag); 
	if( sps_subset->additional_extension2_flag )
	{
		while( more_rbsp_data( b ) )
		{
...
{
    sps_svc_ext_t* sps_svc_ext = sps_subset->sps_svc_ext;
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->inter_layer_deblocking_filter_control_present_flag = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->inter_layer_deblocking_filter_control_present_flag: %d \r\n", sps_svc_ext->inter_layer_deblocking_filter_control_present_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->extended_spatial_scalability_idc = bs_read_u(b, 2); bs_trace("sps_svc_ext->extended_spatial_scalability_idc: %d \r\n", sps_svc_ext->extended_spatial_scalability_idc); 
    if( sps_subset->sps->chroma_format_idc == 1 || sps_subset->sps->chroma_format_idc == 2 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->chroma_phase_x_plus1_flag = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->chroma_phase_x_plus1_flag: %d \r\n", sps_svc_ext->chroma_phase_x_plus1_flag); 
    }
    if( sps_subset->sps->chroma_format_idc == 1 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->chroma_phase_y_plus1 = bs_read_u(b, 2); bs_trace("sps_svc_ext->chroma_phase_y_plus1: %d \r\n", sps_svc_ext->chroma_phase_y_plus1); 
    }
    if( sps_svc_ext->extended_spatial_scalability_idc )
    {
        if( sps_subset->sps->chroma_format_idc > 0 )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->seq_ref_layer_chroma_phase_x_plus1_flag = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->seq_ref_layer_chroma_phase_x_plus1_flag: %d \r\n", sps_svc_ext->seq_ref_layer_chroma_phase_x_plus1_flag); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->seq_ref_layer_chroma_phase_y_plus1 = bs_read_u(b, 2); bs_trace("sps_svc_ext->seq_ref_layer_chroma_phase_y_plus1: %d \r\n", sps_svc_ext->seq_ref_layer_chroma_phase_y_plus1); 
        }
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->seq_scaled_ref_layer_left_offset = bs_read_se(b); bs_trace("sps_svc_ext->seq_scaled_ref_layer_left_offset: %d \r\n", sps_svc_ext->seq_scaled_ref_layer_left_offset); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->seq_scaled_ref_layer_top_offset = bs_read_se(b); bs_trace("sps_svc_ext->seq_scaled_ref_layer_top_offset: %d \r\n", sps_svc_ext->seq_scaled_ref_layer_top_offset); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->seq_scaled_ref_layer_right_offset = bs_read_se(b); bs_trace("sps_svc_ext->seq_scaled_ref_layer_right_offset: %d \r\n", sps_svc_ext->seq_scaled_ref_layer_right_offset); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->seq_scaled_ref_layer_bottom_offset = bs_read_se(b); bs_trace("sps_svc_ext->seq_scaled_ref_layer_bottom_offset: %d \r\n", sps_svc_ext->seq_scaled_ref_layer_bottom_offset); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->seq_tcoeff_level_prediction_flag = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->seq_tcoeff_level_prediction_flag: %d \r\n", sps_svc_ext->seq_tcoeff_level_prediction_flag); 
    if( sps_svc_ext->seq_tcoeff_level_prediction_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->adaptive_tcoeff_level_prediction_flag = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->adaptive_tcoeff_level_prediction_flag: %d \r\n", sps_svc_ext->adaptive_tcoeff_level_prediction_flag); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->slice_header_restriction_flag = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->slice_header_restriction_flag: %d \r\n", sps_svc_ext->slice_header_restriction_flag); 
}

//Appendix G.14.1 SVC VUI parameters extension syntax
void read_debug_svc_vui_parameters_extension(sps_svc_ext_t* sps_svc_ext, bs_t* b)
{
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_num_entries_minus1 = bs_read_ue(b); bs_trace("sps_svc_ext->vui.vui_ext_num_entries_minus1: %d \r\n", sps_svc_ext->vui.vui_ext_num_entries_minus1); 
    for( int i = 0; i <= sps_svc_ext->vui.vui_ext_num_entries_minus1; i++ )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_dependency_id[i] = bs_read_u(b, 3); bs_trace("sps_svc_ext->vui.vui_ext_dependency_id[i]: %d \r\n", sps_svc_ext->vui.vui_ext_dependency_id[i]); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_quality_id[i] = bs_read_u(b, 4); bs_trace("sps_svc_ext->vui.vui_ext_quality_id[i]: %d \r\n", sps_svc_ext->vui.vui_ext_quality_id[i]); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_temporal_id[i] = bs_read_u(b, 3); bs_trace("sps_svc_ext->vui.vui_ext_temporal_id[i]: %d \r\n", sps_svc_ext->vui.vui_ext_temporal_id[i]); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_timing_info_present_flag[i] = bs_read_u1(b); bs_trace("sps_svc_ext->vui.vui_ext_timing_info_present_flag[i]: %d \r\n", sps_svc_ext->vui.vui_ext_timing_info_present_flag[i]); 
        if( sps_svc_ext->vui.vui_ext_timing_info_present_flag[i] )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_num_units_in_tick[i] = bs_read_u(b, 32); bs_trace("sps_svc_ext->vui.vui_ext_num_units_in_tick[i]: %d \r\n", sps_svc_ext->vui.vui_ext_num_units_in_tick[i]); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_time_scale[i] = bs_read_u(b, 32); bs_trace("sps_svc_ext->vui.vui_ext_time_scale[i]: %d \r\n", sps_svc_ext->vui.vui_ext_time_scale[i]); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_fixed_frame_rate_flag[i] = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->vui.vui_ext_fixed_frame_rate_flag[i]: %d \r\n", sps_svc_ext->vui.vui_ext_fixed_frame_rate_flag[i]); 
        }

        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_nal_hrd_parameters_present_flag[i] = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->vui.vui_ext_nal_hrd_parameters_present_flag[i]: %d \r\n", sps_svc_ext->vui.vui_ext_nal_hrd_parameters_present_flag[i]); 
        if( sps_svc_ext->vui.vui_ext_nal_hrd_parameters_present_flag[i] )
        {
            read_debug_hrd_parameters(&sps_svc_ext->hrd_vcl[i], b);
        }
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_vcl_hrd_parameters_present_flag[i] = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->vui.vui_ext_vcl_hrd_parameters_present_flag[i]: %d \r\n", sps_svc_ext->vui.vui_ext_vcl_hrd_parameters_present_flag[i]); 
        if( sps_svc_ext->vui.vui_ext_vcl_hrd_parameters_present_flag[i] )
        {
        ...
        if( sps_svc_ext->vui.vui_ext_nal_hrd_parameters_present_flag[i] ||
            sps_svc_ext->vui.vui_ext_vcl_hrd_parameters_present_flag[i] )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_low_delay_hrd_flag[i] = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->vui.vui_ext_low_delay_hrd_flag[i]: %d \r\n", sps_svc_ext->vui.vui_ext_low_delay_hrd_flag[i]); 
        }
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps_svc_ext->vui.vui_ext_pic_struct_present_flag[i] = bs_read_u1(b) != 0; bs_trace("sps_svc_ext->vui.vui_ext_pic_struct_present_flag[i]: %d \r\n", sps_svc_ext->vui.vui_ext_pic_struct_present_flag[i]); 
    }
}
...
void read_debug_vui_parameters(sps_t* sps, bs_t* b)
{
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.aspect_ratio_info_present_flag = bs_read_u1(b); bs_trace("sps->vui.aspect_ratio_info_present_flag: %d \r\n", sps->vui.aspect_ratio_info_present_flag); 
    if( sps->vui.aspect_ratio_info_present_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.aspect_ratio_idc = bs_read_u8(b); bs_trace("sps->vui.aspect_ratio_idc: %d \r\n", sps->vui.aspect_ratio_idc); 
        if( sps->vui.aspect_ratio_idc == SAR_Extended )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.sar_width = bs_read_u(b, 16); bs_trace("sps->vui.sar_width: %d \r\n", sps->vui.sar_width); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.sar_height = bs_read_u(b, 16); bs_trace("sps->vui.sar_height: %d \r\n", sps->vui.sar_height); 
        }
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.overscan_info_present_flag = bs_read_u1(b); bs_trace("sps->vui.overscan_info_present_flag: %d \r\n", sps->vui.overscan_info_present_flag); 
    if( sps->vui.overscan_info_present_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.overscan_appropriate_flag = bs_read_u1(b); bs_trace("sps->vui.overscan_appropriate_flag: %d \r\n", sps->vui.overscan_appropriate_flag); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.video_signal_type_present_flag = bs_read_u1(b); bs_trace("sps->vui.video_signal_type_present_flag: %d \r\n", sps->vui.video_signal_type_present_flag); 
    if( sps->vui.video_signal_type_present_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.video_format = bs_read_u(b, 3); bs_trace("sps->vui.video_format: %d \r\n", sps->vui.video_format); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.video_full_range_flag = bs_read_u1(b); bs_trace("sps->vui.video_full_range_flag: %d \r\n", sps->vui.video_full_range_flag); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.colour_description_present_flag = bs_read_u1(b); bs_trace("sps->vui.colour_description_present_flag: %d \r\n", sps->vui.colour_description_present_flag); 
        if( sps->vui.colour_description_present_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.colour_primaries = bs_read_u8(b); bs_trace("sps->vui.colour_primaries: %d \r\n", sps->vui.colour_primaries); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.transfer_characteristics = bs_read_u8(b); bs_trace("sps->vui.transfer_characteristics: %d \r\n", sps->vui.transfer_characteristics); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.matrix_coefficients = bs_read_u8(b); bs_trace("sps->vui.matrix_coefficients: %d \r\n", sps->vui.matrix_coefficients); 
        }
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.chroma_loc_info_present_flag = bs_read_u1(b); bs_trace("sps->vui.chroma_loc_info_present_flag: %d \r\n", sps->vui.chroma_loc_info_present_flag); 
    if( sps->vui.chroma_loc_info_present_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.chroma_sample_loc_type_top_field = bs_read_ue(b); bs_trace("sps->vui.chroma_sample_loc_type_top_field: %d \r\n", sps->vui.chroma_sample_loc_type_top_field); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.chroma_sample_loc_type_bottom_field = bs_read_ue(b); bs_trace("sps->vui.chroma_sample_loc_type_bottom_field: %d \r\n", sps->vui.chroma_sample_loc_type_bottom_field); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.timing_info_present_flag = bs_read_u1(b); bs_trace("sps->vui.timing_info_present_flag: %d \r\n", sps->vui.timing_info_present_flag); 
    if( sps->vui.timing_info_present_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.num_units_in_tick = bs_read_u(b, 32); bs_trace("sps->vui.num_units_in_tick: %d \r\n", sps->vui.num_units_in_tick); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.time_scale = bs_read_u(b, 32); bs_trace("sps->vui.time_scale: %d \r\n", sps->vui.time_scale); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.fixed_frame_rate_flag = bs_read_u1(b); bs_trace("sps->vui.fixed_frame_rate_flag: %d \r\n", sps->vui.fixed_frame_rate_flag); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.nal_hrd_parameters_present_flag = bs_read_u1(b); bs_trace("sps->vui.nal_hrd_parameters_present_flag: %d \r\n", sps->vui.nal_hrd_parameters_present_flag); 
    if( sps->vui.nal_hrd_parameters_present_flag )
    {
        read_debug_hrd_parameters(&sps->hrd_nal, b);
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.vcl_hrd_parameters_present_flag = bs_read_u1(b); bs_trace("sps->vui.vcl_hrd_parameters_present_flag: %d \r\n", sps->vui.vcl_hrd_parameters_present_flag); 
    if( sps->vui.vcl_hrd_parameters_present_flag )
    {
    ...
    if( sps->vui.nal_hrd_parameters_present_flag || sps->vui.vcl_hrd_parameters_present_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.low_delay_hrd_flag = bs_read_u1(b); bs_trace("sps->vui.low_delay_hrd_flag: %d \r\n", sps->vui.low_delay_hrd_flag); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.pic_struct_present_flag = bs_read_u1(b); bs_trace("sps->vui.pic_struct_present_flag: %d \r\n", sps->vui.pic_struct_present_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.bitstream_restriction_flag = bs_read_u1(b); bs_trace("sps->vui.bitstream_restriction_flag: %d \r\n", sps->vui.bitstream_restriction_flag); 
    if( sps->vui.bitstream_restriction_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.motion_vectors_over_pic_boundaries_flag = bs_read_u1(b); bs_trace("sps->vui.motion_vectors_over_pic_boundaries_flag: %d \r\n", sps->vui.motion_vectors_over_pic_boundaries_flag); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.max_bytes_per_pic_denom = bs_read_ue(b); bs_trace("sps->vui.max_bytes_per_pic_denom: %d \r\n", sps->vui.max_bytes_per_pic_denom); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.max_bits_per_mb_denom = bs_read_ue(b); bs_trace("sps->vui.max_bits_per_mb_denom: %d \r\n", sps->vui.max_bits_per_mb_denom); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.log2_max_mv_length_horizontal = bs_read_ue(b); bs_trace("sps->vui.log2_max_mv_length_horizontal: %d \r\n", sps->vui.log2_max_mv_length_horizontal); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.log2_max_mv_length_vertical = bs_read_ue(b); bs_trace("sps->vui.log2_max_mv_length_vertical: %d \r\n", sps->vui.log2_max_mv_length_vertical); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.num_reorder_frames = bs_read_ue(b); bs_trace("sps->vui.num_reorder_frames: %d \r\n", sps->vui.num_reorder_frames); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sps->vui.max_dec_frame_buffering = bs_read_ue(b); bs_trace("sps->vui.max_dec_frame_buffering: %d \r\n", sps->vui.max_dec_frame_buffering); 
    }
}
...
void read_debug_hrd_parameters(hrd_t* hrd, bs_t* b)
{
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->cpb_cnt_minus1 = bs_read_ue(b); bs_trace("hrd->cpb_cnt_minus1: %d \r\n", hrd->cpb_cnt_minus1); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->bit_rate_scale = bs_read_u(b, 4); bs_trace("hrd->bit_rate_scale: %d \r\n", hrd->bit_rate_scale); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->cpb_size_scale = bs_read_u(b, 4); bs_trace("hrd->cpb_size_scale: %d \r\n", hrd->cpb_size_scale); 
    for( int SchedSelIdx = 0; SchedSelIdx <= hrd->cpb_cnt_minus1; SchedSelIdx++ )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->bit_rate_value_minus1[ SchedSelIdx ] = bs_read_ue(b); bs_trace("hrd->bit_rate_value_minus1[ SchedSelIdx ]: %d \r\n", hrd->bit_rate_value_minus1[ SchedSelIdx ]); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->cpb_size_value_minus1[ SchedSelIdx ] = bs_read_ue(b); bs_trace("hrd->cpb_size_value_minus1[ SchedSelIdx ]: %d \r\n", hrd->cpb_size_value_minus1[ SchedSelIdx ]); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->cbr_flag[ SchedSelIdx ] = bs_read_u1(b); bs_trace("hrd->cbr_flag[ SchedSelIdx ]: %d \r\n", hrd->cbr_flag[ SchedSelIdx ]); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->initial_cpb_removal_delay_length_minus1 = bs_read_u(b, 5); bs_trace("hrd->initial_cpb_removal_delay_length_minus1: %d \r\n", hrd->initial_cpb_removal_delay_length_minus1); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->cpb_removal_delay_length_minus1 = bs_read_u(b, 5); bs_trace("hrd->cpb_removal_delay_length_minus1: %d \r\n", hrd->cpb_removal_delay_length_minus1); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->dpb_output_delay_length_minus1 = bs_read_u(b, 5); bs_trace("hrd->dpb_output_delay_length_minus1: %d \r\n", hrd->dpb_output_delay_length_minus1); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); hrd->time_offset_length = bs_read_u(b, 5); bs_trace("hrd->time_offset_length: %d \r\n", hrd->time_offset_length); 
}
...
int read_debug_seq_parameter_set_extension_rbsp(bs_t* b, sps_ext_t* sps_ext) {
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); seq_parameter_set_id = bs_read_ue(b); bs_trace("seq_parameter_set_id: %d \r\n", seq_parameter_set_id); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); aux_format_idc = bs_read_ue(b); bs_trace("aux_format_idc: %d \r\n", aux_format_idc); 
    if( aux_format_idc != 0 ) {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); bit_depth_aux_minus8 = bs_read_ue(b); bs_trace("bit_depth_aux_minus8: %d \r\n", bit_depth_aux_minus8); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); alpha_incr_flag = bs_read_u1(b); bs_trace("alpha_incr_flag: %d \r\n", alpha_incr_flag); 
        alpha_opaque_value = bs_read_debug_u(v);
        alpha_transparent_value = bs_read_debug_u(v);
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); additional_extension_flag = bs_read_u1(b); bs_trace("additional_extension_flag: %d \r\n", additional_extension_flag); 
...
void read_debug_pic_parameter_set_rbsp(h264_stream_t* h, bs_t* b)
{
    ...
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->pic_parameter_set_id = bs_read_ue(b); bs_trace("pps->pic_parameter_set_id: %d \r\n", pps->pic_parameter_set_id); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->seq_parameter_set_id = bs_read_ue(b); bs_trace("pps->seq_parameter_set_id: %d \r\n", pps->seq_parameter_set_id); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->entropy_coding_mode_flag = bs_read_u1(b); bs_trace("pps->entropy_coding_mode_flag: %d \r\n", pps->entropy_coding_mode_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->pic_order_present_flag = bs_read_u1(b); bs_trace("pps->pic_order_present_flag: %d \r\n", pps->pic_order_present_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->num_slice_groups_minus1 = bs_read_ue(b); bs_trace("pps->num_slice_groups_minus1: %d \r\n", pps->num_slice_groups_minus1); 

    if( pps->num_slice_groups_minus1 > 0 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->slice_group_map_type = bs_read_ue(b); bs_trace("pps->slice_group_map_type: %d \r\n", pps->slice_group_map_type); 
        if( pps->slice_group_map_type == 0 )
        {
            for( int i_group = 0; i_group <= pps->num_slice_groups_minus1; i_group++ )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->run_length_minus1[ i_group ] = bs_read_ue(b); bs_trace("pps->run_length_minus1[ i_group ]: %d \r\n", pps->run_length_minus1[ i_group ]); 
            }
        }
        else if( pps->slice_group_map_type == 2 )
        {
            for( int i_group = 0; i_group < pps->num_slice_groups_minus1; i_group++ )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->top_left[ i_group ] = bs_read_ue(b); bs_trace("pps->top_left[ i_group ]: %d \r\n", pps->top_left[ i_group ]); 
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->bottom_right[ i_group ] = bs_read_ue(b); bs_trace("pps->bottom_right[ i_group ]: %d \r\n", pps->bottom_right[ i_group ]); 
            }
        }
        else if( pps->slice_group_map_type == 3 ||
                 pps->slice_group_map_type == 4 ||
                 pps->slice_group_map_type == 5 )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->slice_group_change_direction_flag = bs_read_u1(b); bs_trace("pps->slice_group_change_direction_flag: %d \r\n", pps->slice_group_change_direction_flag); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->slice_group_change_rate_minus1 = bs_read_ue(b); bs_trace("pps->slice_group_change_rate_minus1: %d \r\n", pps->slice_group_change_rate_minus1); 
        }
        else if( pps->slice_group_map_type == 6 )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->pic_size_in_map_units_minus1 = bs_read_ue(b); bs_trace("pps->pic_size_in_map_units_minus1: %d \r\n", pps->pic_size_in_map_units_minus1); 
            for( int i = 0; i <= pps->pic_size_in_map_units_minus1; i++ )
            {
                int v = intlog2( pps->num_slice_groups_minus1 + 1 );
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->slice_group_id[ i ] = bs_read_u(b, v); bs_trace("pps->slice_group_id[ i ]: %d \r\n", pps->slice_group_id[ i ]); 
            }
        }
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->num_ref_idx_l0_active_minus1 = bs_read_ue(b); bs_trace("pps->num_ref_idx_l0_active_minus1: %d \r\n", pps->num_ref_idx_l0_active_minus1); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->num_ref_idx_l1_active_minus1 = bs_read_ue(b); bs_trace("pps->num_ref_idx_l1_active_minus1: %d \r\n", pps->num_ref_idx_l1_active_minus1); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->weighted_pred_flag = bs_read_u1(b); bs_trace("pps->weighted_pred_flag: %d \r\n", pps->weighted_pred_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->weighted_bipred_idc = bs_read_u(b, 2); bs_trace("pps->weighted_bipred_idc: %d \r\n", pps->weighted_bipred_idc); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->pic_init_qp_minus26 = bs_read_se(b); bs_trace("pps->pic_init_qp_minus26: %d \r\n", pps->pic_init_qp_minus26); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->pic_init_qs_minus26 = bs_read_se(b); bs_trace("pps->pic_init_qs_minus26: %d \r\n", pps->pic_init_qs_minus26); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->chroma_qp_index_offset = bs_read_se(b); bs_trace("pps->chroma_qp_index_offset: %d \r\n", pps->chroma_qp_index_offset); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->deblocking_filter_control_present_flag = bs_read_u1(b); bs_trace("pps->deblocking_filter_control_present_flag: %d \r\n", pps->deblocking_filter_control_present_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->constrained_intra_pred_flag = bs_read_u1(b); bs_trace("pps->constrained_intra_pred_flag: %d \r\n", pps->constrained_intra_pred_flag); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->redundant_pic_cnt_present_flag = bs_read_u1(b); bs_trace("pps->redundant_pic_cnt_present_flag: %d \r\n", pps->redundant_pic_cnt_present_flag); 
    ...
    if( have_more_data )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->transform_8x8_mode_flag = bs_read_u1(b); bs_trace("pps->transform_8x8_mode_flag: %d \r\n", pps->transform_8x8_mode_flag); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->pic_scaling_matrix_present_flag = bs_read_u1(b); bs_trace("pps->pic_scaling_matrix_present_flag: %d \r\n", pps->pic_scaling_matrix_present_flag); 
        if( pps->pic_scaling_matrix_present_flag )
        {
            for( int i = 0; i < 6 + 2* pps->transform_8x8_mode_flag; i++ )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->pic_scaling_list_present_flag[ i ] = bs_read_u1(b); bs_trace("pps->pic_scaling_list_present_flag[ i ]: %d \r\n", pps->pic_scaling_list_present_flag[ i ]); 
                if( pps->pic_scaling_list_present_flag[ i ] )
                {
                    if( i < 6 )
                    {
        ...
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); pps->second_chroma_qp_index_offset = bs_read_se(b); bs_trace("pps->second_chroma_qp_index_offset: %d \r\n", pps->second_chroma_qp_index_offset); 
    }
...
void read_debug_access_unit_delimiter_rbsp(h264_stream_t* h, bs_t* b)
{
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); h->aud->primary_pic_type = bs_read_u(b, 3); bs_trace("h->aud->primary_pic_type: %d \r\n", h->aud->primary_pic_type); 
}
...
void read_debug_filler_data_rbsp(h264_stream_t* h, bs_t* b)
{
    while( bs_next_bits(b, 8) == 0xFF )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); int ff_byte = bs_read_u(b, 8); bs_trace("ff_byte: %d \r\n", ff_byte); 
    }
}
...
//7.3.2.9.2 Slice data partition B RBSP syntax
slice_data_partition_b_layer_rbsp( ) {
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); slice_id = bs_read_ue(b); bs_trace("slice_id: %d \r\n", slice_id);     // only category 3
    if( redundant_pic_cnt_present_flag )
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); redundant_pic_cnt = bs_read_ue(b); bs_trace("redundant_pic_cnt: %d \r\n", redundant_pic_cnt); 
...
void read_debug_rbsp_slice_trailing_bits(h264_stream_t* h, bs_t* b)
{
    ...
    if( h->pps->entropy_coding_mode_flag )
    {
        while( more_rbsp_trailing_data(h, b) )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); int cabac_zero_word = bs_read_u(b, 16); bs_trace("cabac_zero_word: %d \r\n", cabac_zero_word); 
        }
    }
}
...
void read_debug_rbsp_trailing_bits(bs_t* b)
{
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); int rbsp_stop_one_bit = bs_read_u(b, 1); bs_trace("rbsp_stop_one_bit: %d \r\n", rbsp_stop_one_bit); 

    while( !bs_byte_aligned(b) )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); int rbsp_alignment_zero_bit = bs_read_u(b, 1); bs_trace("rbsp_alignment_zero_bit: %d \r\n", rbsp_alignment_zero_bit); 
    }
}
...
void read_debug_slice_header(h264_stream_t* h, bs_t* b)
{
    ...
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->first_mb_in_slice = bs_read_ue(b); bs_trace("sh->first_mb_in_slice: %d \r\n", sh->first_mb_in_slice); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->slice_type = bs_read_ue(b); bs_trace("sh->slice_type: %d \r\n", sh->slice_type); 
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pic_parameter_set_id = bs_read_ue(b); bs_trace("sh->pic_parameter_set_id: %d \r\n", sh->pic_parameter_set_id); 
    ...
    if (sps->residual_colour_transform_flag)
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->colour_plane_id = bs_read_u(b, 2); bs_trace("sh->colour_plane_id: %d \r\n", sh->colour_plane_id); 
    }

    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->frame_num = bs_read_u(b, sps->log2_max_frame_num_minus4 + 4 ); bs_trace("sh->frame_num: %d \r\n", sh->frame_num);  // was u(v)
    if( !sps->frame_mbs_only_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->field_pic_flag = bs_read_u1(b); bs_trace("sh->field_pic_flag: %d \r\n", sh->field_pic_flag); 
        if( sh->field_pic_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->bottom_field_flag = bs_read_u1(b); bs_trace("sh->bottom_field_flag: %d \r\n", sh->bottom_field_flag); 
        }
    }
    if( nal->nal_unit_type == 5 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->idr_pic_id = bs_read_ue(b); bs_trace("sh->idr_pic_id: %d \r\n", sh->idr_pic_id); 
    }
    if( sps->pic_order_cnt_type == 0 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pic_order_cnt_lsb = bs_read_u(b, sps->log2_max_pic_order_cnt_lsb_minus4 + 4 ); bs_trace("sh->pic_order_cnt_lsb: %d \r\n", sh->pic_order_cnt_lsb);  // was u(v)
        if( pps->pic_order_present_flag && !sh->field_pic_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->delta_pic_order_cnt_bottom = bs_read_se(b); bs_trace("sh->delta_pic_order_cnt_bottom: %d \r\n", sh->delta_pic_order_cnt_bottom); 
        }
    }
    if( sps->pic_order_cnt_type == 1 && !sps->delta_pic_order_always_zero_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->delta_pic_order_cnt[ 0 ] = bs_read_se(b); bs_trace("sh->delta_pic_order_cnt[ 0 ]: %d \r\n", sh->delta_pic_order_cnt[ 0 ]); 
        if( pps->pic_order_present_flag && !sh->field_pic_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->delta_pic_order_cnt[ 1 ] = bs_read_se(b); bs_trace("sh->delta_pic_order_cnt[ 1 ]: %d \r\n", sh->delta_pic_order_cnt[ 1 ]); 
        }
    }
    if( pps->redundant_pic_cnt_present_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->redundant_pic_cnt = bs_read_ue(b); bs_trace("sh->redundant_pic_cnt: %d \r\n", sh->redundant_pic_cnt); 
    }
    if( is_slice_type( sh->slice_type, SH_SLICE_TYPE_B ) )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->direct_spatial_mv_pred_flag = bs_read_u1(b); bs_trace("sh->direct_spatial_mv_pred_flag: %d \r\n", sh->direct_spatial_mv_pred_flag); 
    }
    if( is_slice_type( sh->slice_type, SH_SLICE_TYPE_P ) || is_slice_type( sh->slice_type, SH_SLICE_TYPE_SP ) || is_slice_type( sh->slice_type, SH_SLICE_TYPE_B ) )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->num_ref_idx_active_override_flag = bs_read_u1(b); bs_trace("sh->num_ref_idx_active_override_flag: %d \r\n", sh->num_ref_idx_active_override_flag); 
        if( sh->num_ref_idx_active_override_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->num_ref_idx_l0_active_minus1 = bs_read_ue(b); bs_trace("sh->num_ref_idx_l0_active_minus1: %d \r\n", sh->num_ref_idx_l0_active_minus1);  // FIXME does this modify the pps?
            if( is_slice_type( sh->slice_type, SH_SLICE_TYPE_B ) )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->num_ref_idx_l1_active_minus1 = bs_read_ue(b); bs_trace("sh->num_ref_idx_l1_active_minus1: %d \r\n", sh->num_ref_idx_l1_active_minus1); 
            }
        }
    }
    ...
    if( pps->entropy_coding_mode_flag && ! is_slice_type( sh->slice_type, SH_SLICE_TYPE_I ) && ! is_slice_type( sh->slice_type, SH_SLICE_TYPE_SI ) )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->cabac_init_idc = bs_read_ue(b); bs_trace("sh->cabac_init_idc: %d \r\n", sh->cabac_init_idc); 
    }
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->slice_qp_delta = bs_read_se(b); bs_trace("sh->slice_qp_delta: %d \r\n", sh->slice_qp_delta); 
    if( is_slice_type( sh->slice_type, SH_SLICE_TYPE_SP ) || is_slice_type( sh->slice_type, SH_SLICE_TYPE_SI ) )
    {
        if( is_slice_type( sh->slice_type, SH_SLICE_TYPE_SP ) )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->sp_for_switch_flag = bs_read_u1(b); bs_trace("sh->sp_for_switch_flag: %d \r\n", sh->sp_for_switch_flag); 
        }
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->slice_qs_delta = bs_read_se(b); bs_trace("sh->slice_qs_delta: %d \r\n", sh->slice_qs_delta); 
    }
    if( pps->deblocking_filter_control_present_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->disable_deblocking_filter_idc = bs_read_ue(b); bs_trace("sh->disable_deblocking_filter_idc: %d \r\n", sh->disable_deblocking_filter_idc); 
        if( sh->disable_deblocking_filter_idc != 1 )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->slice_alpha_c0_offset_div2 = bs_read_se(b); bs_trace("sh->slice_alpha_c0_offset_div2: %d \r\n", sh->slice_alpha_c0_offset_div2); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->slice_beta_offset_div2 = bs_read_se(b); bs_trace("sh->slice_beta_offset_div2: %d \r\n", sh->slice_beta_offset_div2); 
        }
    }
    if( pps->num_slice_groups_minus1 > 0 &&
        pps->slice_group_map_type >= 3 && pps->slice_group_map_type <= 5)
    {
        int v = intlog2( pps->pic_size_in_map_units_minus1 +  pps->slice_group_change_rate_minus1 + 1 );
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->slice_group_change_cycle = bs_read_u(b, v); bs_trace("sh->slice_group_change_cycle: %d \r\n", sh->slice_group_change_cycle);  // FIXME add 2?
    }
}
...
void read_debug_ref_pic_list_reordering(h264_stream_t* h, bs_t* b)
{
    ...
    if( ! is_slice_type( sh->slice_type, SH_SLICE_TYPE_I ) && ! is_slice_type( sh->slice_type, SH_SLICE_TYPE_SI ) )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->rplr.ref_pic_list_reordering_flag_l0 = bs_read_u1(b); bs_trace("sh->rplr.ref_pic_list_reordering_flag_l0: %d \r\n", sh->rplr.ref_pic_list_reordering_flag_l0); 
        if( sh->rplr.ref_pic_list_reordering_flag_l0 )
        {
            int n = -1;
            do
            {
                n++;
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->rplr.reorder_l0.reordering_of_pic_nums_idc[ n ] = bs_read_ue(b); bs_trace("sh->rplr.reorder_l0.reordering_of_pic_nums_idc[ n ]: %d \r\n", sh->rplr.reorder_l0.reordering_of_pic_nums_idc[ n ]); 
                if( sh->rplr.reorder_l0.reordering_of_pic_nums_idc[ n ] == 0 ||
                    sh->rplr.reorder_l0.reordering_of_pic_nums_idc[ n ] == 1 )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->rplr.reorder_l0.abs_diff_pic_num_minus1[ n ] = bs_read_ue(b); bs_trace("sh->rplr.reorder_l0.abs_diff_pic_num_minus1[ n ]: %d \r\n", sh->rplr.reorder_l0.abs_diff_pic_num_minus1[ n ]); 
                }
                else if( sh->rplr.reorder_l0.reordering_of_pic_nums_idc[ n ] == 2 )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->rplr.reorder_l0.long_term_pic_num[ n ] = bs_read_ue(b); bs_trace("sh->rplr.reorder_l0.long_term_pic_num[ n ]: %d \r\n", sh->rplr.reorder_l0.long_term_pic_num[ n ]); 
                }
            } while( sh->rplr.reorder_l0.reordering_of_pic_nums_idc[ n ] != 3 && ! bs_eof(b) );
        }
    }
    if( is_slice_type( sh->slice_type, SH_SLICE_TYPE_B ) )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->rplr.ref_pic_list_reordering_flag_l1 = bs_read_u1(b); bs_trace("sh->rplr.ref_pic_list_reordering_flag_l1: %d \r\n", sh->rplr.ref_pic_list_reordering_flag_l1); 
        if( sh->rplr.ref_pic_list_reordering_flag_l1 )
        {
            int n = -1;
            do
            {
                n++;
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->rplr.reorder_l1.reordering_of_pic_nums_idc[ n ] = bs_read_ue(b); bs_trace("sh->rplr.reorder_l1.reordering_of_pic_nums_idc[ n ]: %d \r\n", sh->rplr.reorder_l1.reordering_of_pic_nums_idc[ n ]); 
                if( sh->rplr.reorder_l1.reordering_of_pic_nums_idc[ n ] == 0 ||
                    sh->rplr.reorder_l1.reordering_of_pic_nums_idc[ n ] == 1 )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->rplr.reorder_l1.abs_diff_pic_num_minus1[ n ] = bs_read_ue(b); bs_trace("sh->rplr.reorder_l1.abs_diff_pic_num_minus1[ n ]: %d \r\n", sh->rplr.reorder_l1.abs_diff_pic_num_minus1[ n ]); 
                }
                else if( sh->rplr.reorder_l1.reordering_of_pic_nums_idc[ n ] == 2 )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->rplr.reorder_l1.long_term_pic_num[ n ] = bs_read_ue(b); bs_trace("sh->rplr.reorder_l1.long_term_pic_num[ n ]: %d \r\n", sh->rplr.reorder_l1.long_term_pic_num[ n ]); 
                }
            } while( sh->rplr.reorder_l1.reordering_of_pic_nums_idc[ n ] != 3 && ! bs_eof(b) );
        }
    }
...
void read_debug_pred_weight_table(h264_stream_t* h, bs_t* b)
{
    ...
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.luma_log2_weight_denom = bs_read_ue(b); bs_trace("sh->pwt.luma_log2_weight_denom: %d \r\n", sh->pwt.luma_log2_weight_denom); 
    if( sps->chroma_format_idc != 0 ) //FIXME ChromaArrayType may differ from chroma_format_idc
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.chroma_log2_weight_denom = bs_read_ue(b); bs_trace("sh->pwt.chroma_log2_weight_denom: %d \r\n", sh->pwt.chroma_log2_weight_denom); 
    }
    for( i = 0; i <= pps->num_ref_idx_l0_active_minus1; i++ )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.luma_weight_l0_flag[i] = bs_read_u1(b); bs_trace("sh->pwt.luma_weight_l0_flag[i]: %d \r\n", sh->pwt.luma_weight_l0_flag[i]); 
        if( sh->pwt.luma_weight_l0_flag[i] )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.luma_weight_l0[ i ] = bs_read_se(b); bs_trace("sh->pwt.luma_weight_l0[ i ]: %d \r\n", sh->pwt.luma_weight_l0[ i ]); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.luma_offset_l0[ i ] = bs_read_se(b); bs_trace("sh->pwt.luma_offset_l0[ i ]: %d \r\n", sh->pwt.luma_offset_l0[ i ]); 
        }
        if ( sps->chroma_format_idc != 0 ) //FIXME ChromaArrayType may differ from chroma_format_idc
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.chroma_weight_l0_flag[i] = bs_read_u1(b); bs_trace("sh->pwt.chroma_weight_l0_flag[i]: %d \r\n", sh->pwt.chroma_weight_l0_flag[i]); 
            if( sh->pwt.chroma_weight_l0_flag[i] )
            {
                for( j =0; j < 2; j++ )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.chroma_weight_l0[ i ][ j ] = bs_read_se(b); bs_trace("sh->pwt.chroma_weight_l0[ i ][ j ]: %d \r\n", sh->pwt.chroma_weight_l0[ i ][ j ]); 
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.chroma_offset_l0[ i ][ j ] = bs_read_se(b); bs_trace("sh->pwt.chroma_offset_l0[ i ][ j ]: %d \r\n", sh->pwt.chroma_offset_l0[ i ][ j ]); 
                }
            }
        }
    }
    if( is_slice_type( sh->slice_type, SH_SLICE_TYPE_B ) )
    {
        for( i = 0; i <= pps->num_ref_idx_l1_active_minus1; i++ )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.luma_weight_l1_flag[i] = bs_read_u1(b); bs_trace("sh->pwt.luma_weight_l1_flag[i]: %d \r\n", sh->pwt.luma_weight_l1_flag[i]); 
            if( sh->pwt.luma_weight_l1_flag[i] )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.luma_weight_l1[ i ] = bs_read_se(b); bs_trace("sh->pwt.luma_weight_l1[ i ]: %d \r\n", sh->pwt.luma_weight_l1[ i ]); 
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.luma_offset_l1[ i ] = bs_read_se(b); bs_trace("sh->pwt.luma_offset_l1[ i ]: %d \r\n", sh->pwt.luma_offset_l1[ i ]); 
            }
            if( sps->chroma_format_idc != 0 )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.chroma_weight_l1_flag[i] = bs_read_u1(b); bs_trace("sh->pwt.chroma_weight_l1_flag[i]: %d \r\n", sh->pwt.chroma_weight_l1_flag[i]); 
                if( sh->pwt.chroma_weight_l1_flag[i] )
                {
                    for( j = 0; j < 2; j++ )
                    {
                        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.chroma_weight_l1[ i ][ j ] = bs_read_se(b); bs_trace("sh->pwt.chroma_weight_l1[ i ][ j ]: %d \r\n", sh->pwt.chroma_weight_l1[ i ][ j ]); 
                        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pwt.chroma_offset_l1[ i ][ j ] = bs_read_se(b); bs_trace("sh->pwt.chroma_offset_l1[ i ][ j ]: %d \r\n", sh->pwt.chroma_offset_l1[ i ][ j ]); 
                    }
                }
            }
        }
...
void read_debug_dec_ref_pic_marking(h264_stream_t* h, bs_t* b)
{
    ...
    if( h->nal->nal_unit_type == 5 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->drpm.no_output_of_prior_pics_flag = bs_read_u1(b); bs_trace("sh->drpm.no_output_of_prior_pics_flag: %d \r\n", sh->drpm.no_output_of_prior_pics_flag); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->drpm.long_term_reference_flag = bs_read_u1(b); bs_trace("sh->drpm.long_term_reference_flag: %d \r\n", sh->drpm.long_term_reference_flag); 
    }
    else
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->drpm.adaptive_ref_pic_marking_mode_flag = bs_read_u1(b); bs_trace("sh->drpm.adaptive_ref_pic_marking_mode_flag: %d \r\n", sh->drpm.adaptive_ref_pic_marking_mode_flag); 
        if( sh->drpm.adaptive_ref_pic_marking_mode_flag )
        {
            int n = -1;
            do
            {
                n++;
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->drpm.memory_management_control_operation[ n ] = bs_read_ue(b); bs_trace("sh->drpm.memory_management_control_operation[ n ]: %d \r\n", sh->drpm.memory_management_control_operation[ n ]); 
                if( sh->drpm.memory_management_control_operation[ n ] == 1 ||
                    sh->drpm.memory_management_control_operation[ n ] == 3 )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->drpm.difference_of_pic_nums_minus1[ n ] = bs_read_ue(b); bs_trace("sh->drpm.difference_of_pic_nums_minus1[ n ]: %d \r\n", sh->drpm.difference_of_pic_nums_minus1[ n ]); 
                }
                if(sh->drpm.memory_management_control_operation[ n ] == 2 )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->drpm.long_term_pic_num[ n ] = bs_read_ue(b); bs_trace("sh->drpm.long_term_pic_num[ n ]: %d \r\n", sh->drpm.long_term_pic_num[ n ]); 
                }
                if( sh->drpm.memory_management_control_operation[ n ] == 3 ||
                    sh->drpm.memory_management_control_operation[ n ] == 6 )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->drpm.long_term_frame_idx[ n ] = bs_read_ue(b); bs_trace("sh->drpm.long_term_frame_idx[ n ]: %d \r\n", sh->drpm.long_term_frame_idx[ n ]); 
                }
                if( sh->drpm.memory_management_control_operation[ n ] == 4 )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->drpm.max_long_term_frame_idx_plus1[ n ] = bs_read_ue(b); bs_trace("sh->drpm.max_long_term_frame_idx_plus1[ n ]: %d \r\n", sh->drpm.max_long_term_frame_idx_plus1[ n ]); 
                }
            } while( sh->drpm.memory_management_control_operation[ n ] != 0 && ! bs_eof(b) );
        }
    }
...
void read_debug_slice_header_in_scalable_extension(h264_stream_t* h, bs_t* b)
{
    ...
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->frame_num = bs_read_u(b, sps_subset->sps->log2_max_frame_num_minus4 + 4 ); bs_trace("sh->frame_num: %d \r\n", sh->frame_num);  // was u(v)
    if( !sps_subset->sps->frame_mbs_only_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->field_pic_flag = bs_read_u1(b); bs_trace("sh->field_pic_flag: %d \r\n", sh->field_pic_flag); 
        if( sh->field_pic_flag )
    ...
    if( sps_subset->sps->pic_order_cnt_type == 0 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->pic_order_cnt_lsb = bs_read_u(b, sps_subset->sps->log2_max_pic_order_cnt_lsb_minus4 + 4 ); bs_trace("sh->pic_order_cnt_lsb: %d \r\n", sh->pic_order_cnt_lsb);  // was u(v)
        if( pps->pic_order_present_flag && !sh->field_pic_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh->delta_pic_order_cnt_bottom = bs_read_se(b); bs_trace("sh->delta_pic_order_cnt_bottom: %d \r\n", sh->delta_pic_order_cnt_bottom); 
        }
    ...
    if( nal->nal_svc_ext->quality_id == 0)
    {
            ...
            ( pps->weighted_bipred_idc == 1 && is_slice_type( sh->slice_type, SH_SLICE_TYPE_EB ) ) )
        {
            ...
            if( !nal->nal_svc_ext->no_inter_layer_pred_flag )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->base_pred_weight_table_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->base_pred_weight_table_flag: %d \r\n", sh_svc_ext->base_pred_weight_table_flag); 
            }
            if( nal->nal_svc_ext->no_inter_layer_pred_flag || !sh_svc_ext->base_pred_weight_table_flag )
            {
                read_debug_pred_weight_table(h, b);
        ...
        if( nal->nal_ref_idc != 0 )
        {
            ...
            if( !sps_subset->sps_svc_ext->slice_header_restriction_flag )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->store_ref_base_pic_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->store_ref_base_pic_flag: %d \r\n", sh_svc_ext->store_ref_base_pic_flag); 
                if( ( nal->nal_svc_ext->use_ref_base_pic_flag || sh_svc_ext->store_ref_base_pic_flag ) &&
                   ( nal->nal_unit_type != 5 ) )
                {
                    read_debug_dec_ref_base_pic_marking(nal, b);
    ...
    if( !nal->nal_svc_ext->no_inter_layer_pred_flag && nal->nal_svc_ext->quality_id == 0 )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->ref_layer_dq_id = bs_read_ue(b); bs_trace("sh_svc_ext->ref_layer_dq_id: %d \r\n", sh_svc_ext->ref_layer_dq_id); 
        if( sps_subset->sps_svc_ext->inter_layer_deblocking_filter_control_present_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->disable_inter_layer_deblocking_filter_idc = bs_read_ue(b); bs_trace("sh_svc_ext->disable_inter_layer_deblocking_filter_idc: %d \r\n", sh_svc_ext->disable_inter_layer_deblocking_filter_idc); 
            if( sh_svc_ext->disable_inter_layer_deblocking_filter_idc != 1 )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->inter_layer_slice_alpha_c0_offset_div2 = bs_read_se(b); bs_trace("sh_svc_ext->inter_layer_slice_alpha_c0_offset_div2: %d \r\n", sh_svc_ext->inter_layer_slice_alpha_c0_offset_div2); 
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->inter_layer_slice_beta_offset_div2 = bs_read_se(b); bs_trace("sh_svc_ext->inter_layer_slice_beta_offset_div2: %d \r\n", sh_svc_ext->inter_layer_slice_beta_offset_div2); 
            }
        }
        
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->constrained_intra_resampling_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->constrained_intra_resampling_flag: %d \r\n", sh_svc_ext->constrained_intra_resampling_flag); 
        if( sps_subset->sps_svc_ext->extended_spatial_scalability_idc == 2 )
        {
            if( sps_subset->sps->chroma_format_idc > 0 )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->ref_layer_chroma_phase_x_plus1_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->ref_layer_chroma_phase_x_plus1_flag: %d \r\n", sh_svc_ext->ref_layer_chroma_phase_x_plus1_flag); 
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->ref_layer_chroma_phase_y_plus1 = bs_read_u(b, 2); bs_trace("sh_svc_ext->ref_layer_chroma_phase_y_plus1: %d \r\n", sh_svc_ext->ref_layer_chroma_phase_y_plus1); 
            }
            
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->scaled_ref_layer_left_offset = bs_read_se(b); bs_trace("sh_svc_ext->scaled_ref_layer_left_offset: %d \r\n", sh_svc_ext->scaled_ref_layer_left_offset); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->scaled_ref_layer_top_offset = bs_read_se(b); bs_trace("sh_svc_ext->scaled_ref_layer_top_offset: %d \r\n", sh_svc_ext->scaled_ref_layer_top_offset); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->scaled_ref_layer_right_offset = bs_read_se(b); bs_trace("sh_svc_ext->scaled_ref_layer_right_offset: %d \r\n", sh_svc_ext->scaled_ref_layer_right_offset); 
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->scaled_ref_layer_bottom_offset = bs_read_se(b); bs_trace("sh_svc_ext->scaled_ref_layer_bottom_offset: %d \r\n", sh_svc_ext->scaled_ref_layer_bottom_offset); 
        }
    }
    
    if( !nal->nal_svc_ext->no_inter_layer_pred_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->slice_skip_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->slice_skip_flag: %d \r\n", sh_svc_ext->slice_skip_flag); 
        if( sh_svc_ext->slice_skip_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->num_mbs_in_slice_minus1 = bs_read_ue(b); bs_trace("sh_svc_ext->num_mbs_in_slice_minus1: %d \r\n", sh_svc_ext->num_mbs_in_slice_minus1); 
        }
        else
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->adaptive_base_mode_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->adaptive_base_mode_flag: %d \r\n", sh_svc_ext->adaptive_base_mode_flag); 
            if( !sh_svc_ext->adaptive_base_mode_flag )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->default_base_mode_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->default_base_mode_flag: %d \r\n", sh_svc_ext->default_base_mode_flag); 
            }
            if( !sh_svc_ext->default_base_mode_flag )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->adaptive_motion_prediction_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->adaptive_motion_prediction_flag: %d \r\n", sh_svc_ext->adaptive_motion_prediction_flag); 
                if( !sh_svc_ext->adaptive_motion_prediction_flag )
                {
                    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->default_motion_prediction_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->default_motion_prediction_flag: %d \r\n", sh_svc_ext->default_motion_prediction_flag); 
                }
            }
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->adaptive_residual_prediction_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->adaptive_residual_prediction_flag: %d \r\n", sh_svc_ext->adaptive_residual_prediction_flag); 
            if( !sh_svc_ext->adaptive_residual_prediction_flag )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->default_residual_prediction_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->default_residual_prediction_flag: %d \r\n", sh_svc_ext->default_residual_prediction_flag); 
            }
        }
        if( sps_subset->sps_svc_ext->adaptive_tcoeff_level_prediction_flag )
        {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->tcoeff_level_prediction_flag = bs_read_u1(b) != 0; bs_trace("sh_svc_ext->tcoeff_level_prediction_flag: %d \r\n", sh_svc_ext->tcoeff_level_prediction_flag); 
        }
    }
    
    if( !sps_subset->sps_svc_ext->slice_header_restriction_flag && !sh_svc_ext->slice_skip_flag )
    {
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->scan_idx_start = bs_read_u(b, 4); bs_trace("sh_svc_ext->scan_idx_start: %d \r\n", sh_svc_ext->scan_idx_start); 
        bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); sh_svc_ext->scan_idx_end = bs_read_u(b, 4); bs_trace("sh_svc_ext->scan_idx_end: %d \r\n", sh_svc_ext->scan_idx_end); 
    }
}
...
void read_debug_dec_ref_base_pic_marking(nal_t* nal, bs_t* b)
{
    bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->prefix_nal_svc->adaptive_ref_base_pic_marking_mode_flag = bs_read_u1(b) != 0; bs_trace("nal->prefix_nal_svc->adaptive_ref_base_pic_marking_mode_flag: %d \r\n", nal->prefix_nal_svc->adaptive_ref_base_pic_marking_mode_flag); 
    if( nal->prefix_nal_svc->adaptive_ref_base_pic_marking_mode_flag )
    {
        do {
            bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->prefix_nal_svc->memory_management_base_control_operation = bs_read_ue(b); bs_trace("nal->prefix_nal_svc->memory_management_base_control_operation: %d \r\n", nal->prefix_nal_svc->memory_management_base_control_operation); 
            
            if( nal->prefix_nal_svc->memory_management_base_control_operation == 1 )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->prefix_nal_svc->difference_of_base_pic_nums_minus1 = bs_read_ue(b); bs_trace("nal->prefix_nal_svc->difference_of_base_pic_nums_minus1: %d \r\n", nal->prefix_nal_svc->difference_of_base_pic_nums_minus1); 
            }
            if( nal->prefix_nal_svc->memory_management_base_control_operation == 2 )
            {
                bs_trace("%ld.%d: ", (long int)(b->p - b->start), b->bits_left); nal->prefix_nal_svc->long_term_base_pic_num = bs_read_ue(b); bs_trace("nal->prefix_nal_svc->long_term_base_pic_num: %d \r\n", nal->prefix_nal_svc->long_term_base_pic_num); 
            }
        } while( nal->prefix_nal_svc->memory_management_base_control_operation != 0 );
    }
}
